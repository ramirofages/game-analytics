...
class CheckpointsControllerTest < ActionController::TestCase
  ...
  test "should create checkpoint" do
    assert_difference('Checkpoint.count') do
      post :create, checkpoint: { activationCount: @checkpoint.activationCount, level_id: @checkpoint.level_id, number: @checkpoint.number }
    end
  ...
  test "should update checkpoint" do
    patch :update, id: @checkpoint, checkpoint: { activationCount: @checkpoint.activationCount, level_id: @checkpoint.level_id, number: @checkpoint.number }
    assert_redirected_to checkpoint_path(assigns(:checkpoint))
  end
